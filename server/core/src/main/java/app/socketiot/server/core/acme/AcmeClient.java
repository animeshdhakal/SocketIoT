package app.socketiot.server.core.acme;
...
public class AcmeClient {
    ...
    public AcmeClient(String email, String host) {
        this(PRODUCTION, email, host);
    }

    public AcmeClient(String letsEncryptUrl, String email, String host) {
