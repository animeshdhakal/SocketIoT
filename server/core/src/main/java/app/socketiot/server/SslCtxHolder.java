...
public class SslCtxHolder {
    ...
    private static final Logger log = LogManager.getLogger(SslCtxHolder.class);

    public SslCtxHolder(ServerProperties props, boolean isSslEnabled) {
        if (isSslEnabled) {
            log.info("SSL Enabled");

            String certPath = props.getProperty("ssl.cert");
            String keyPath = props.getProperty("ssl.key");
            String keyPass = props.getProperty("ssl.key.password");
            String email = props.getProperty("ssl.email");
