...
public abstract class ProtocolDetector extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        buildPipeline(ctx.pipeline(), headerBytes).remove(this);
    }

    private static boolean isHttp(long headerBytes) {
        return headerBytes == 1195725856L || // 'GET '
    ...
    private ChannelPipeline buildPipeline(ChannelPipeline pipeline, long headerBytes) {
